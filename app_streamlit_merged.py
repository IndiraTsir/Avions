...
part = st.sidebar.radio(label='Pages', options=('Intro', 'Airline Cancellations and Delays', 'Flight App', 'Analysys 3', 'Analysis Total', 'Conclusions'))
...
elif part == 'Airline Cancellations and Delays':
    st.title('Airline Cancellations')
